...
# ]
# masks_path_src = [
#     "../img_data/0003SET/000/IMG_0000_1_mask.tif",
#     "../img_data/0003SET/000/IMG_0000_2_mask.tif",
#     "../img_data/0003SET/000/IMG_0000_3_mask.tif",
#     "../img_data/0003SET/000/IMG_0000_4_mask.tif",
#     "../img_data/0003SET/000/IMG_0000_5_mask.tif"
# ]
# masks_path_ref = [
#     "../img_data/Multicam_0915-1416_mask.tif",
#     "../img_data/Multicam_0915-1416_mask.tif",
#     "../img_data/Multicam_0915-1416_mask.tif",
#     "../img_data/Multicam_0915-1416_mask.tif",
#     "../img_data/Multicam_0915-1416_mask.tif"
...
ms_paths = [
    "../img_data/sumavska/0005SET/000/IMG_0034_1.tif", "../img_data/sumavska/0005SET/000/IMG_0034_2.tif",
    "../img_data/sumavska/0005SET/000/IMG_0034_3.tif", "../img_data/sumavska/0005SET/000/IMG_0034_4.tif"
]
masks_path_src = [None, None, None, None]
# masks_path_src = [
#     "../img_data/sumavska/0005SET/000/mask_ms.tif",
#     "../img_data/sumavska/0005SET/000/mask_ms.tif",
#     "../img_data/sumavska/0005SET/000/mask_ms.tif",
#     "../img_data/sumavska/0005SET/000/mask_ms.tif"
# ]
...
filter_paths = [
    "../filters_sensors/AltumPT_Blue_RSR.xlsx", "../filters_sensors/AltumPT_Green_RSR.xlsx",
    "../filters_sensors/AltumPT_Red_RSR.xlsx", "../filters_sensors/AltumPT_Red_Edge_RSR.xlsx"
]
sensor_paths = [
...
ms_cam_model.out_data.imshow([3, 2, 1])
plt.show()
